...
project = u'TensorForce-Client'
copyright = u'2018, reinforce.io'
author = u'reinforce.io / ducandu research GmbH'

github_doc_root = 'https://github.com/reinforceio/tensorforce-client/tree/master/docs/'
